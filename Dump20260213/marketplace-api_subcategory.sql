...
CREATE TABLE `subcategory` (
  ...
  KEY `ix_subcategory_category` (`category_id`),
  CONSTRAINT `fk_subcategory_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`) ON DELETE RESTRICT
...
INSERT INTO `subcategory` VALUES (1,'TV & Video',1),(2,'Smartphones',1),(3,'Audio',1),(4,'Kitchen',2),(5,'Consoles',3);
